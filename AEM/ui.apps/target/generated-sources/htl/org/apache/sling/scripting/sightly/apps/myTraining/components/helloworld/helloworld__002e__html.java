...
out.write("</h1>\r\n    </div>\r\n    ");
_global_model = renderContext.call("use", com.myTraining.core.models.HelloWorldModel.class.getName(), obj());
out.write("<div class=\"cmp-helloworld\">\r\n        ");
{
    Object var_testvariable5 = renderContext.getObjectModel().resolveProperty(_global_model, "email");
    if (renderContext.getObjectModel().toBoolean(var_testvariable5)) {
        out.write("<div class=\"cmp-helloworld__item\">\r\n            <p class=\"cmp-helloworld__item-label\">Email:</p>\r\n            <pre class=\"cmp-helloworld__item-output\">");
        {
